...
const DropdownCard = ({ props, children }) => {
  ...
  return (
    <div className='rounded-lg overflow-hidden shadow mb-4'>
      <div
        className='bg-white cursor-pointer justify-between items-center'
        ...
        <div className='flex px-4 py-2 '>
          <div className="flex flex-wrap w-1/2">
            <div className="flex flex-col w-1/4">
              <span className="text-md font-medium text-gray-400">Aircrafts</span>
              <span className="font-medium">{props.aircrafts}</span>
            </div>
            <div className="flex flex-col w-1/4">
